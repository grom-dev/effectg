...
type MethodRequired<M extends keyof MethodParams> = (parameters: MethodParams[M]) => Effect.Effect<MethodResults[M], HttpClientError | BotApiError>
type MethodOptional<M extends keyof MethodParams> = (parameters?: MethodParams[M]) => Effect.Effect<MethodResults[M], HttpClientError | BotApiError>
...
export interface BotApiShape {
   ...
   */
  getUpdates: MethodOptional<'getUpdates'>
  /**
   ...
   */
  setWebhook: MethodRequired<'setWebhook'>
  ...
  deleteWebhook: MethodOptional<'deleteWebhook'>
  ...
  forwardMessage: MethodRequired<'forwardMessage'>
  /** Use this method to forward multiple messages of any kind. If some of the specified messages can't be found or forwarded, they are skipped. Service messages and messages with protected content can't be forwarded. Album grouping is kept for forwarded messages. On success, an array of [MessageId](https://core.telegram.org/bots/api#messageid) of the sent messages is returned. */
  forwardMessages: MethodRequired<'forwardMessages'>
  ...
  copyMessage: MethodRequired<'copyMessage'>
  ...
  sendMediaGroup: MethodRequired<'sendMediaGroup'>
  /** Use this method to send point on the map. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendLocation: MethodRequired<'sendLocation'>
  /** Use this method to send information about a venue. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendVenue: MethodRequired<'sendVenue'>
  /** Use this method to send phone contacts. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendContact: MethodRequired<'sendContact'>
  /** Use this method to send a native poll. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendPoll: MethodRequired<'sendPoll'>
  ...
  sendChecklist: MethodRequired<'sendChecklist'>
  /** Use this method to send an animated emoji that will display a random value. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendDice: MethodRequired<'sendDice'>
  /**
   ...
   */
  sendChatAction: MethodRequired<'sendChatAction'>
  ...
  setMessageReaction: MethodRequired<'setMessageReaction'>
  /** Use this method to get a list of profile pictures for a user. Returns a [UserProfilePhotos](https://core.telegram.org/bots/api#userprofilephotos) object. */
  getUserProfilePhotos: MethodRequired<'getUserProfilePhotos'>
  ...
  setUserEmojiStatus: MethodRequired<'setUserEmojiStatus'>
  /**
   ...
   */
  getFile: MethodRequired<'getFile'>
  ...
  banChatMember: MethodRequired<'banChatMember'>
  ...
  unbanChatMember: MethodRequired<'unbanChatMember'>
  ...
  restrictChatMember: MethodRequired<'restrictChatMember'>
  ...
  unbanChatSenderChat: MethodRequired<'unbanChatSenderChat'>
  ...
  setChatPermissions: MethodRequired<'setChatPermissions'>
  /**
   ...
   */
  exportChatInviteLink: MethodRequired<'exportChatInviteLink'>
  /** Use this method to create an additional invite link for a chat. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. The link can be revoked using the method [revokeChatInviteLink](https://core.telegram.org/bots/api#revokechatinvitelink). Returns the new invite link as [ChatInviteLink](https://core.telegram.org/bots/api#chatinvitelink) object. */
  createChatInviteLink: MethodRequired<'createChatInviteLink'>
  /** Use this method to edit a non-primary invite link created by the bot. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns the edited invite link as a [ChatInviteLink](https://core.telegram.org/bots/api#chatinvitelink) object. */
  editChatInviteLink: MethodRequired<'editChatInviteLink'>
  ...
  createChatSubscriptionInviteLink: MethodRequired<'createChatSubscriptionInviteLink'>
  ...
  editChatSubscriptionInviteLink: MethodRequired<'editChatSubscriptionInviteLink'>
  /** Use this method to revoke an invite link created by the bot. If the primary link is revoked, a new link is automatically generated. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns the revoked invite link as [ChatInviteLink](https://core.telegram.org/bots/api#chatinvitelink) object. */
  revokeChatInviteLink: MethodRequired<'revokeChatInviteLink'>
  ...
  approveChatJoinRequest: MethodRequired<'approveChatJoinRequest'>
  ...
  declineChatJoinRequest: MethodRequired<'declineChatJoinRequest'>
  ...
  setChatPhoto: MethodRequired<'setChatPhoto'>
  ...
  deleteChatPhoto: MethodRequired<'deleteChatPhoto'>
  ...
  setChatTitle: MethodRequired<'setChatTitle'>
  ...
  setChatDescription: MethodRequired<'setChatDescription'>
  ...
  pinChatMessage: MethodRequired<'pinChatMessage'>
  ...
  unpinChatMessage: MethodRequired<'unpinChatMessage'>
  ...
  setChatStickerSet: MethodRequired<'setChatStickerSet'>
  /** Use this method to delete a group sticker set from a supergroup. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Use the field _can\_set\_sticker\_set_ optionally returned in [getChat](https://core.telegram.org/bots/api#getchat) requests to check if the bot can use this method. Returns _True_ on success. */
  deleteChatStickerSet: MethodRequired<'deleteChatStickerSet'>
  /** Use this method to get custom emoji stickers, which can be used as a forum topic icon by any user. Requires no parameters. Returns an Array of [Sticker](https://core.telegram.org/bots/api#sticker) objects. */
  getForumTopicIconStickers: MethodOptional<'getForumTopicIconStickers'>
  ...
  createForumTopic: MethodRequired<'createForumTopic'>
  ...
  editForumTopic: MethodRequired<'editForumTopic'>
  ...
  closeForumTopic: MethodRequired<'closeForumTopic'>
  ...
  reopenForumTopic: MethodRequired<'reopenForumTopic'>
  ...
  deleteForumTopic: MethodRequired<'deleteForumTopic'>
  ...
  unpinAllForumTopicMessages: MethodRequired<'unpinAllForumTopicMessages'>
  ...
  editGeneralForumTopic: MethodRequired<'editGeneralForumTopic'>
  ...
  closeGeneralForumTopic: MethodRequired<'closeGeneralForumTopic'>
  ...
  reopenGeneralForumTopic: MethodRequired<'reopenGeneralForumTopic'>
  ...
  hideGeneralForumTopic: MethodRequired<'hideGeneralForumTopic'>
  ...
  unhideGeneralForumTopic: MethodRequired<'unhideGeneralForumTopic'>
  ...
  unpinAllGeneralForumTopicMessages: MethodRequired<'unpinAllGeneralForumTopicMessages'>
  /**
   ...
   */
  answerCallbackQuery: MethodRequired<'answerCallbackQuery'>
  ...
  getUserChatBoosts: MethodRequired<'getUserChatBoosts'>
  ...
  getBusinessConnection: MethodRequired<'getBusinessConnection'>
  ...
  setMyCommands: MethodRequired<'setMyCommands'>
  ...
  deleteMyCommands: MethodOptional<'deleteMyCommands'>
  ...
  getMyCommands: MethodOptional<'getMyCommands'>
  /** Use this method to change the bot's name. Returns _True_ on success. */
  setMyName: MethodOptional<'setMyName'>
  ...
  getMyName: MethodOptional<'getMyName'>
  ...
  setMyDescription: MethodOptional<'setMyDescription'>
  ...
  getMyDescription: MethodOptional<'getMyDescription'>
  ...
  setMyShortDescription: MethodOptional<'setMyShortDescription'>
  ...
  getMyShortDescription: MethodOptional<'getMyShortDescription'>
  /** Use this method to change the bot's menu button in a private chat, or the default menu button. Returns _True_ on success. */
  setChatMenuButton: MethodOptional<'setChatMenuButton'>
  /** Use this method to get the current value of the bot's menu button in a private chat, or the default menu button. Returns [MenuButton](https://core.telegram.org/bots/api#menubutton) on success. */
  getChatMenuButton: MethodOptional<'getChatMenuButton'>
  ...
  setMyDefaultAdministratorRights: MethodOptional<'setMyDefaultAdministratorRights'>
  /** Use this method to get the current default administrator rights of the bot. Returns [ChatAdministratorRights](https://core.telegram.org/bots/api#chatadministratorrights) on success. */
  getMyDefaultAdministratorRights: MethodOptional<'getMyDefaultAdministratorRights'>
  ...
  getAvailableGifts: MethodOptional<'getAvailableGifts'>
  ...
  sendGift: MethodRequired<'sendGift'>
  /** Gifts a Telegram Premium subscription to the given user. Returns _True_ on success. */
  giftPremiumSubscription: MethodRequired<'giftPremiumSubscription'>
  ...
  verifyUser: MethodRequired<'verifyUser'>
  ...
  verifyChat: MethodRequired<'verifyChat'>
  ...
  removeUserVerification: MethodRequired<'removeUserVerification'>
  ...
  removeChatVerification: MethodRequired<'removeChatVerification'>
  ...
  readBusinessMessage: MethodRequired<'readBusinessMessage'>
  ...
  deleteBusinessMessages: MethodRequired<'deleteBusinessMessages'>
  ...
  setBusinessAccountName: MethodRequired<'setBusinessAccountName'>
  ...
  setBusinessAccountUsername: MethodRequired<'setBusinessAccountUsername'>
  ...
  setBusinessAccountBio: MethodRequired<'setBusinessAccountBio'>
  ...
  setBusinessAccountProfilePhoto: MethodRequired<'setBusinessAccountProfilePhoto'>
  ...
  removeBusinessAccountProfilePhoto: MethodRequired<'removeBusinessAccountProfilePhoto'>
  ...
  setBusinessAccountGiftSettings: MethodRequired<'setBusinessAccountGiftSettings'>
  ...
  getBusinessAccountStarBalance: MethodRequired<'getBusinessAccountStarBalance'>
  ...
  transferBusinessAccountStars: MethodRequired<'transferBusinessAccountStars'>
  ...
  getBusinessAccountGifts: MethodRequired<'getBusinessAccountGifts'>
  ...
  convertGiftToStars: MethodRequired<'convertGiftToStars'>
  ...
  upgradeGift: MethodRequired<'upgradeGift'>
  ...
  transferGift: MethodRequired<'transferGift'>
  ...
  postStory: MethodRequired<'postStory'>
  ...
  editStory: MethodRequired<'editStory'>
  ...
  deleteStory: MethodRequired<'deleteStory'>
  ...
  editMessageText: MethodRequired<'editMessageText'>
  /** Use this method to edit captions of messages. On success, if the edited message is not an inline message, the edited [Message](https://core.telegram.org/bots/api#message) is returned, otherwise _True_ is returned. Note that business messages that were not sent by the bot and do not contain an inline keyboard can only be edited within **48 hours** from the time they were sent. */
  editMessageCaption: MethodOptional<'editMessageCaption'>
  ...
  editMessageMedia: MethodRequired<'editMessageMedia'>
  ...
  editMessageLiveLocation: MethodRequired<'editMessageLiveLocation'>
  ...
  stopMessageLiveLocation: MethodOptional<'stopMessageLiveLocation'>
  ...
  editMessageChecklist: MethodRequired<'editMessageChecklist'>
  /** Use this method to edit only the reply markup of messages. On success, if the edited message is not an inline message, the edited [Message](https://core.telegram.org/bots/api#message) is returned, otherwise _True_ is returned. Note that business messages that were not sent by the bot and do not contain an inline keyboard can only be edited within **48 hours** from the time they were sent. */
  editMessageReplyMarkup: MethodOptional<'editMessageReplyMarkup'>
  /** Use this method to stop a poll which was sent by the bot. On success, the stopped [Poll](https://core.telegram.org/bots/api#poll) is returned. */
  stopPoll: MethodRequired<'stopPoll'>
  ...
  approveSuggestedPost: MethodRequired<'approveSuggestedPost'>
  ...
  declineSuggestedPost: MethodRequired<'declineSuggestedPost'>
  /**
   ...
   */
  deleteMessage: MethodRequired<'deleteMessage'>
  ...
  deleteMessages: MethodRequired<'deleteMessages'>
  /** Use this method to send static .WEBP, [animated](https://telegram.org/blog/animated-stickers) .TGS, or [video](https://telegram.org/blog/video-stickers-better-reactions) .WEBM stickers. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendSticker: MethodRequired<'sendSticker'>
  /** Use this method to get a sticker set. On success, a [StickerSet](https://core.telegram.org/bots/api#stickerset) object is returned. */
  getStickerSet: MethodRequired<'getStickerSet'>
  /** Use this method to get information about custom emoji stickers by their identifiers. Returns an Array of [Sticker](https://core.telegram.org/bots/api#sticker) objects. */
  getCustomEmojiStickers: MethodRequired<'getCustomEmojiStickers'>
  /** Use this method to upload a file with a sticker for later use in the [createNewStickerSet](https://core.telegram.org/bots/api#createnewstickerset), [addStickerToSet](https://core.telegram.org/bots/api#addstickertoset), or [replaceStickerInSet](https://core.telegram.org/bots/api#replacestickerinset) methods (the file can be used multiple times). Returns the uploaded [File](https://core.telegram.org/bots/api#file) on success. */
  uploadStickerFile: MethodRequired<'uploadStickerFile'>
  ...
  createNewStickerSet: MethodRequired<'createNewStickerSet'>
  ...
  replaceStickerInSet: MethodRequired<'replaceStickerInSet'>
  ...
  setStickerEmojiList: MethodRequired<'setStickerEmojiList'>
  ...
  setStickerKeywords: MethodRequired<'setStickerKeywords'>
  ...
  setStickerMaskPosition: MethodRequired<'setStickerMaskPosition'>
  /** Use this method to set the title of a created sticker set. Returns _True_ on success. */
  setStickerSetTitle: MethodRequired<'setStickerSetTitle'>
  ...
  savePreparedInlineMessage: MethodRequired<'savePreparedInlineMessage'>
  /** Use this method to send invoices. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendInvoice: MethodRequired<'sendInvoice'>
  /** Use this method to create a link for an invoice. Returns the created invoice link as _String_ on success. */
  createInvoiceLink: MethodRequired<'createInvoiceLink'>
  ...
  answerShippingQuery: MethodRequired<'answerShippingQuery'>
  ...
  answerPreCheckoutQuery: MethodRequired<'answerPreCheckoutQuery'>
  ...
  getMyStarBalance: MethodOptional<'getMyStarBalance'>
   ...
   */
  setPassportDataErrors: MethodRequired<'setPassportDataErrors'>
  /** Use this method to send a game. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
  sendGame: MethodRequired<'sendGame'>
  ...
  setGameScore: MethodRequired<'setGameScore'>
  /**
   ...
   */
  getGameHighScores: MethodRequired<'getGameHighScores'>
}
